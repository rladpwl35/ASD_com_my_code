        ...
        if epoch % 20 == 0:
            ...
            if args.aug_mode == "sample_v3": 
                ...
                if 'balanced' in args.root_unsupervised:
                    ...
                    torch.save(model.gnn.state_dict(), "./weights/aug2/roi/joao_" + str(args.gamma) + '_' + str(args.gnn_type) + '_' + 'batch' + str(args.batch_size) + '_' + unsupervised_path + '_' + str(epoch) + '_' + str(args.num_layer) + ".pth")
